...
const OptionsCard = ({obj}) => {
  return (
    <motion.div variants={fadeIn("left", "tween", 0.5, 1)} className="w-full  h-[350px] md:w-[380px] border border-gray-700 rounded-2xl group shadow-lg hover:shadow-lg hover:shadow-[#8cd790]/[0.4] flex flex-col gap-6 justify-center items-center z-30 bg-white ">
