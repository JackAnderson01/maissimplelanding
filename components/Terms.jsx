    ...
    <div className="w-full h-auto flex flex-col justify-start items-start">
      ...
      <div className="w-full h-auto  flex flex-col justify-start items-center px-2 md:px-10 py-2 md:py-6 lg:py-8 mt-10 gap-4 my-16 lg:gap-8">
        <div className="w-full h-auto flex items-center justify-center">
          <h1 className="text-4xl  font-bold text-[#8cd790] ">
            Terms of Service
          </h1>
        </div>

        <div className="w-full lg:w-[80%] h-auto px-0 lg:px-20 relative">
          <img
            src="/assets/flowerfull.svg"
            alt=""
            className="absolute -top-28 hidden lg:block -right-10 -z-10 rotate-90"
          />
          ...
          <div className="w-full h-auto z-[1000] rounded-3xl flex flex-col gap-3 justify-start items-start  text-lg font-medium bg-gray-50 p-6 lg:p-10 ">
            <div className="w-full flex flex-col gap-1 justify-start items-start">
              <h1 className="text-[#8cd790] font-semibold text-xl">
          ...
          <img
            src="/assets/flowerfull.svg"
            alt=""
            className="absolute hidden lg:block -bottom-16 -left-0 -z-10"
          />
        </div>
      </div>
